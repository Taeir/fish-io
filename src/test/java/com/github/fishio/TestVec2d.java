...
public class TestVec2d {
	...
	public void testdistanceSquared() {
		Vec2d vec1 = new Vec2d(1, 1);
		Vec2d vec2 = new Vec2d(1, 4);
		assertEquals(9, vec1.distanceSquared(vec2), 0.0);
	}
	...
	public void testdistance() {
		Vec2d vec1 = new Vec2d(2, 1);
		Vec2d vec2 = new Vec2d(1, 3);
		assertEquals(4, vec1.distance(-2, 1), 0.0);
		assertEquals(Math.sqrt(5), vec1.distance(vec2), 0.0);
	}
	...
	public void testlength() {
		...
		Vec2d vec3 = new Vec2d(1, 2);
		assertEquals(Math.sqrt(5), vec3.length(), 0.0);
	...
	public void testnormalizeNoException() {
		...
		assertEquals(1 / (Math.sqrt(5)), vec1.normalize().x, 0.0);
		assertEquals(2 / (Math.sqrt(5)), vec1.normalize().y, 0.0);
	}
	...
	/**
	 * Test for {@link Vec2d#equals(Object)} with an unequal object. In this
	 * case both x and y are unequal.
	 */
	@Test
