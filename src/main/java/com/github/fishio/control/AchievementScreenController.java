...
public class AchievementScreenController implements ScreenController {
	...
	/*
	 * @FXML private Label smallachieve31;
	 * 
	 * @FXML private Label smallachieve32;
	 * 
	 * @FXML private Label smallachieve33;
	 * 
	 * @FXML private Label smallachieve34;
	 * 
	 * @FXML private Label smallachieve35;
	 * 
	 * @FXML private Label smallachieve41;
	 * 
	 * @FXML private Label smallachieve42;
	 * 
	 * @FXML private Label smallachieve43;
	 * 
	 * @FXML private Label smallachieve44;
	 * 
	 * @FXML private Label smallachieve45;
	 * 
	 * @FXML private Label smallachieve51;
	 * 
	 * @FXML private Label smallachieve52;
	 * 
	 * @FXML private Label smallachieve53;
	 * 
	 * @FXML private Label smallachieve54;
	 * 
	 * @FXML private Label smallachieve55;
	 * 
	 * @FXML private Label smallachieve61;
	 * 
	 * @FXML private Label smallachieve62;
	 * 
	 * @FXML private Label smallachieve63;
	 * 
	 * @FXML private Label smallachieve64;
	 * 
	 * @FXML private Label smallachieve65;
	 * 
	 * @FXML private Label smallachieve71;
	 * 
	 * @FXML private Label smallachieve72;
	 * 
	 * @FXML private Label smallachieve73;
	 * 
	 * @FXML private Label smallachieve74;
	 * 
	 * @FXML private Label smallachieve75;
	 */
	@FXML
	...
	/*
	 * @FXML private Label icon31;
	 * 
	 * @FXML private Label icon32;
	 * 
	 * @FXML private Label icon33;
	 * 
	 * @FXML private Label icon34;
	 * 
	 * @FXML private Label icon35;
	 * 
	 * @FXML private Label icon41;
	 * 
	 * @FXML private Label icon42;
	 * 
	 * @FXML private Label icon43;
	 * 
	 * @FXML private Label icon44;
	 * 
	 * @FXML private Label icon45;
	 * 
	 * @FXML private Label icon51;
	 * 
	 * @FXML private Label icon52;
	 * 
	 * @FXML private Label icon53;
	 * 
	 * @FXML private Label icon54;
	 * 
	 * @FXML private Label icon55;
	 * 
	 * @FXML private Label icon61;
	 * 
	 * @FXML private Label icon62;
	 * 
	 * @FXML private Label icon63;
	 * 
	 * @FXML private Label icon64;
	 * 
	 * @FXML private Label icon65;
	 * 
	 * @FXML private Label icon71;
	 * 
	 * @FXML private Label icon72;
	 * 
	 * @FXML private Label icon73;
	 * 
	 * @FXML private Label icon74;
	 * 
	 * @FXML private Label icon75;
	 * 
	 */
	/**
	...
	public void init(Scene scene) {
		...
		/*
		 * smallachieve31.setOpacity(0.1); smallachieve32.setOpacity(0.1);
		 * smallachieve33.setOpacity(0.1); smallachieve34.setOpacity(0.1);
		 * smallachieve35.setOpacity(0.1); smallachieve41.setOpacity(0.1);
		 * smallachieve42.setOpacity(0.1); smallachieve43.setOpacity(0.1);
		 * smallachieve44.setOpacity(0.1); smallachieve45.setOpacity(0.1);
		 * smallachieve51.setOpacity(0.1); smallachieve52.setOpacity(0.1);
		 * smallachieve53.setOpacity(0.1); smallachieve54.setOpacity(0.1);
		 * smallachieve55.setOpacity(0.1); smallachieve61.setOpacity(0.1);
		 * smallachieve62.setOpacity(0.1); smallachieve63.setOpacity(0.1);
		 * smallachieve64.setOpacity(0.1); smallachieve65.setOpacity(0.1);
		 * smallachieve71.setOpacity(0.1); smallachieve72.setOpacity(0.1);
		 * smallachieve73.setOpacity(0.1); smallachieve74.setOpacity(0.1);
